...
class SearchController < ApplicationController
  ...
  def updatehotelstable
    ...
    #tmp = {"name"=>"Jurys Inn Dublin Parnell Street", "rank"=>"8.5", "location"=>"-6.2629097700119,53.3516304175292", "address"=>"Dublin City Centre, Dublin", "roomtype"=>"Standard Double Room", "bedtype"=>"1 full bed", "price"=>"169"},{"name"=>"InterContinental Dublin", "rank"=>"8.9", "location"=>"-6.22588187456131,53.3265575248694", "address"=>"Ballsbridge, Dublin", "roomtype"=>"Standard Double Room", "bedtype"=>"1 full bed", "price"=>"275"},{"name"=>"Harcourt Hotel", "rank"=>"8.0", "location"=>"-6.2629097700119,53.3344512464095", "address"=>"Saint Stephen's Green, Dublin", "roomtype"=>"Twin Room (Maximum Occupancy: 2 People)", "bedtype"=>"2 twin beds", "price"=>"89"}
